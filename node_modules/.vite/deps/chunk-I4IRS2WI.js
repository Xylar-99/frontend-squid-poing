    ...
    ThinParticleSystem = class _ThinParticleSystem extends BaseParticleSystem {
      ...
      async _initShaderSourceAsync() {
        ...
        if (engine.isWebGPU && !_ThinParticleSystem.ForceGLSL) {
          ...
          await Promise.all([import("./particles.vertex-5HU2DXKU.js"), import("./particles.fragment-OFR673Z4.js")]);
        } else {
          await Promise.all([import("./particles.vertex-GXGKFZXG.js"), import("./particles.fragment-THXNVY66.js")]);
        }
      ...
      _render(blendMode) {
        ...
        if (this._vertexArrayObject !== void 0) {
          if ((_a = this._scene) == null ? void 0 : _a.forceWireframe) {
            ...
            this._engine.bindVertexArrayObject(this._vertexArrayObject, ((_b = this._scene) == null ? void 0 : _b.forceWireframe) ? this._linesIndexBufferUseInstancing : this._indexBuffer);
          }
        } else {
          if (!this._indexBuffer) {
            engine.bindBuffers(this._vertexBuffers, ((_c = this._scene) == null ? void 0 : _c.forceWireframe) ? this._linesIndexBufferUseInstancing : null, effect);
          } else {
            engine.bindBuffers(this._vertexBuffers, ((_d = this._scene) == null ? void 0 : _d.forceWireframe) ? this._linesIndexBuffer : this._indexBuffer, effect);
          }
        }
        ...
        if (this._useInstancing) {
          ...
          if ((_f = this._scene) == null ? void 0 : _f.forceWireframe) {
    ...
    ParticleSystem = class _ParticleSystem extends ThinParticleSystem {
      ...
      _onDispose(disposeAttachedSubEmitters = false, disposeEndSubEmitters = false) {
        ...
        if (disposeAttachedSubEmitters) {
          (_a = this.particles) == null ? void 0 : _a.forEach((particle) => {
            if (particle._attachedSubEmitters) {
...
//# sourceMappingURL=chunk-I4IRS2WI.js.map
