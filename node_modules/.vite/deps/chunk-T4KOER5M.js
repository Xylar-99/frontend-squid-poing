...
} from "./chunk-DTHGH6NW.js";
import {
  EffectWrapper,
  init_effectRenderer
} from "./chunk-LS7FPZDK.js";
import {
  Light,
  init_light
    ...
    ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
      _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
          ...
          list.push(Promise.all([import("./kernelBlur.fragment-MWUQGU2I.js"), import("./kernelBlur.vertex-QTQ6H6AD.js")]));
        } else {
          list.push(Promise.all([import("./kernelBlur.fragment-6FOIFHWJ.js"), import("./kernelBlur.vertex-F2IJ6TCM.js")]));
        }
      }
      /**
    ...
    ShadowGenerator = class _ShadowGenerator {
      ...
      async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
          ...
          await Promise.all([
            import("./shadowMap.fragment-LVPL3YRI.js"),
            import("./shadowMap.vertex-BRET3W2V.js"),
            import("./depthBoxBlur.fragment-WOPWEV2W.js"),
            import("./shadowMapFragmentSoftTransparentShadow-EPTHIUKK.js")
          ]);
        } else {
          await Promise.all([
            import("./shadowMap.fragment-MUZEIPRH.js"),
            import("./shadowMap.vertex-V5KP6NN6.js"),
            import("./depthBoxBlur.fragment-JABKOWCM.js"),
            import("./shadowMapFragmentSoftTransparentShadow-MDG4FW2I.js")
          ]);
        }
...
//# sourceMappingURL=chunk-T4KOER5M.js.map
